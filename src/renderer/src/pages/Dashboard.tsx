      ...
      <main className="flex-grow max-w-7xl w-full mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
          ...
          {(user?.operations || user?.isAdmin) && (
            <div onClick={() => navigateTo('/activeinpatients')}>
              <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 hover:shadow-md cursor-pointer transition-all transform hover:-translate-y-1 hover:border-indigo-100">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900">Active In-Patients</h3>
                </div>
                <p className="text-gray-600 ml-16">View active in-patients and operations</p>
              </div>
            </div>
          )}
